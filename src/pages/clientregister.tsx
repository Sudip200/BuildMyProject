      ...
      <div className='flex justify-center items-center h-dvh'>
        ...
        <div className="flex flex-col items-center bg-gray-800 p-8 rounded-lg shadow-lg w-70">
          ...
          <form onSubmit={handleSingUpWithEmail} className="w-full">
            ...
            <button type="submit"
              className="w-full bg-violet-900 hover:bg-blue-950 text-white p-3 rounded-md font-bold">Register</button>
          </form>
          <button onClick={handleLogin}
            ...
            <Image src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google logo" width={20}
              height={20} />
        ...
        (<div className='m-auto w-80 flex items-center justify-center flex-col gap-4 bg-gray-800 p-8 rounded'>
          ...
          <form onSubmit={handleLoginWithEmail} className="w-full">
            ...
            <button type="submit"
              className="w-full bg-violet-900 hover:bg-violet-950 text-white p-3 rounded-md font-bold">Login</button>
          </form>
          <button onClick={handleLogin}
            className="mt-6 w-full bg-gray-700 text-gray-300 border border-gray-600 p-3 rounded-md flex items-center justify-center">
            <Image src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google logo" width={20}
