...
return (
  ...
  <div className="flex  flex-row justify-between items-center gap-1 ">
    <div className="flex flex-col items-start lg:items-center lg:w-1/3">
      <h2 className="lg:text-2xl sm:text-xl font-semibold mb-1 text-violet-400 truncate">{item.data.Title}</h2>
    </div>
    ...
    <div className="flex flex-col items-start lg:items-center lg:w-1/3">
      ...
      <button
        className="bg-violet-900 hover:bg-violet-950 text-white px-5 py-2 rounded-md font-bold transition-colors text-sm"
        onClick={() => {
